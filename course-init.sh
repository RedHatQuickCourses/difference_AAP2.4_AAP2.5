...
execute_init()
{
	...
	sed -i "s/difference_AAP2.4_AAP2.5/${REPONAME}/g" *.* > /dev/null 2>&1
	sed -i "s/difference_AAP2.4_AAP2.5/${REPONAME}/g" supplemental-ui/partials/header-content.hbs > /dev/null 2>&1
	echo -e "done"
